...
import image6 from "../assets/camp.png";
    ...
    <ScrollView style={styles.scrollView}>
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.buttonStyle}>
          <Text style={styles.buttonText} onPress={AllDonors}>
            Find Blood Donor
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.buttonStyle}>
          <Text style={styles.buttonText} onPress={DonorDay}>
